 ...
 * Date: (10/11/22)
 * Section: (0014)
 * Assignment: (BlogProgram part 6)
 * Due Date: (10/12/22)
 * About this project: (This program creates a set amount of blog posts)
 * Assumptions: (assume user correct input)
All work below was performed by (Gerald Martinez) */
...
//sets up Users
void initUsers(vector<User> *Users);
//display menu
void displayMenu();
...
//implement Action
void implementAction(vector<Area> *areas, string strCh, string strAlias);
...
//log in user
int Login(vector<User> *Users, int *index);
...
int main() {
    ...
    do {
        ...
        implementAction(&areas, UserAction,users[index].getAlias());
